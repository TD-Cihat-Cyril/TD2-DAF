...
--
-- Host: localhost
-- Generation Time: Oct 03, 2014 at 11:36 AM
...
--
-- Database: `my_sionapolitano`
--

-- --------------------------------------------------------

--
-- Table structure for table `AffectationVehicule`
--

CREATE TABLE IF NOT EXISTS `AffectationVehicule` (
  `idVisiteur` varchar(6) NOT NULL,
  `mois` date NOT NULL,
  `ImmatVehicule` varchar(11) NOT NULL,
  PRIMARY KEY (`idVisiteur`,`mois`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `AffectationVehicule`
--

INSERT INTO `AffectationVehicule` (`idVisiteur`, `mois`, `ImmatVehicule`) VALUES
('a131', '2014-11-13', 'CY-111-LL'),
('a131', '2014-10-01', 'CZ-501-SR'),
('cn20', '2015-06-11', 'GE-999-FF');
...
('cn20', '09', 0, '0.00', '2014-10-01', 'CR'),
('cn20', '10', 0, '0.00', '2014-10-22', 'CR');
...
('a55', 'Bedos', 'Christian', 'cbedos', 'toolsun', '1 rue Peranud', '46250', 'Montcuq', '1995-01-12'),
...
('cn20', 'napolitano', 'cyril', 'cyril', 'toolsun', '19 rue gayet', '42000', 'Saint Etienne', '2014-09-01'),
('daf', 'daf', 'daf', 'daf', 'daf', '2 rue du daf', '42100', 'daf', '2014-10-01'),
('cc20', 'napolitano', 'cyril', 'cyrils', 'tools', '19 rue gayet', '42000', 'Saint Etienne', '2014-09-01'),
('cd0', 'DAVULCU', 'cihat', 'cdav', '111', '12', '32000', 'strfc', '2014-10-01');
